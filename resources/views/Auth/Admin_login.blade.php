...
<head>
    ...
    <title>Admin Login - Kape Na!</title>
    ...
    <main class="login-main">
        <div class="login-container">
            ...
            <form id="loginForm" action="{{ route('admin.login') }}" method="post">
                ...
                <div class="register-link" style="text-align: center; margin-top: 3rem; font-size: 1.6rem; color: var(--light-color);">
                    <p>Don't have an admin account? <a href="{{ route('admin.register') }}" style="color: var(--admin-color); text-decoration: none; font-weight: bold;">Register here</a></p>
                </div>
            </form>
            <div class="back-home">
